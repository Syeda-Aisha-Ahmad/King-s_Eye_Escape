  ...
  return (
    <div className="grid grid-cols-1">
      ...
      <div className="flex flex-col bg-black p-1">
        ...
        <p className="antialiased text-white text-sm ml-5 mt-1 md:text-2xl">2</p>
        </div>
        <div className="flex flex-row py-2">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-current text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <p className="antialiased text-white text-sm ml-5 mt-1 md:text-2xl">60 minutes</p>
        </div>
        <div className="flex flex-row py-2">
        <BrainSVG />
        <p className="antialiased text-white text-sm ml-5 mt-1 md:text-2xl">Difficulty: 5 out of 5</p>
        </div>
        <div className="flex flex-row py-2">
        <ToxicSVG />
        <p className="antialiased text-white text-sm ml-5 mt-1 md:text-2xl">Genre: Post Apocalpytic / Survival</p>
        </div>
      </div>
      <Link to='/book_now'>
