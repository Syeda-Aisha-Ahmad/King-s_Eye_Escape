...
const Main = () => {
  ...
  >
      ...
      <div className="bg-black flex flex-col xl:h-full">
        ...
        <h1 className="text-white text-center bg-black text-2xl md:text-4xl xl:text-6xl xl:leading-relaxed">Our Escape Rooms</h1>
